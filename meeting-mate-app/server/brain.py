...
MAX_FOLLOW_UPS = 2
# Follow-up で許可するツール（read-only のみ。書き込み系は副作用リスクがあるため除外）
_FOLLOW_UP_ALLOWED_TOOLS = {
...
## 利用可能な追加ツール
knowledge_base_search, calculate, get_current_time, get_meeting_context, summarize_discussion, create_task, generate_diagram, search_past_meetings
